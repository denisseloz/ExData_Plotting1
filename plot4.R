...
setwd('C://Users/Denisse/Documents/DenisseR')
...
with(subpower,{plot(subpower$Time,as.numeric(as.character(subpower$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
